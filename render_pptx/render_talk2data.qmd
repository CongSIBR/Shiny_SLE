...
::: notes
you can write the commits here when you use the Speaker Model
:::
...
make_st <- function(gse) {
  ...
  reactable::reactable(
    ...
    #         htmltools::tags$summary("Show Full text"),
    #         df$value[index]
    #       )
    #     )
    #   }
...
```{r}
#| label: tbl-PMID35383111
#| tbl-cap: "Cell Type Counts"
